<template>
    <div :style="{marginTop:appMarginTop}" style="padding-bottom: 47px;">
        <div class="mcht-data-head">
            ...
            <div class="mcht-data-head-title">{{isApprove ? '项目审核' : '项目详情'}}</div>
        </div>
        <!-- 项目沉淀资金 -->
        <template v-if="params.deposit">
            <div class="title">
                <img src="../../assets/images/examine/duigong_bar_col.png" alt="">
                <span>项目沉淀资金</span>
            </div>
            <div class="deposit">
                <div>
                    <span>{{params.deposit.merchants_money}}</span>
                    <p>商户资金/万元</p>
                </div>
                <div>
                    <span>{{params.deposit.undertakes_money}}</span>
                    <p>代发奖金/万元</p>
                </div>
                <div>
                    <span>{{params.deposit.brought_money}}</span>
                    <p>对公资金/万元</p>
                </div>
                <div>
                    <span>{{params.deposit.guest_money}}</span>
                    <p>获客资金/万元</p>
                </div>
            </div>
        </template>
        ...
        <div class="content">
            <div class="cont-item">
                <label class="w110">一次性投入</label>
                <span class="red">{{params.one_investment}}</span>
            </div>
            <div class="cont-item">
                <label class="w110">逐年投入</label>
                <span class="red">{{params.gradually_investment}}</span>
            </div>
            <div class="cont-item">
                <label class="w110">总投入</label>
                <span class="red">{{params.all_investment}}</span>
            </div>
            <div class="cont-item">
                <div class="flex">
                    <label class="w110">B到C获客情况</label>
                    <div class="cont-btn">
                        <a href="javascript:;" @click="tapPreview(params.account, 'B到C获客情况')">预览</a>
                    </div>
                </div>
            </div>
            <div class="cont-item">
                <label class="w110">硬件成本</label>
                <span class="red">{{params.cost_hardware}}</span>
            </div>
            <div class="cont-item">
                <label class="w110">软件成本</label>
                <span class="red">{{params.cost_software}}</span>
            </div>
            <div class="cont-item">
                <label class="w110">支付通道接口费</label>
                <span class="red">{{params.cost_channels}}</span>
            </div>
            <div class="cont-item" style="border-bottom: none;">
                <label class="w110">其他费用</label>
                <span class="red">{{params.cost_other}}</span>
            </div>
        ...
        <div class="content">
            <div class="cont-item" :style="{borderBottom: params.is_undertakes == '是' ? '1px solid #E4E4E4' : 'none'}">
                <label class="w110">代发合作</label>
                <span>{{params.is_undertakes}}</span>
            </div>
            <template v-if="params.is_undertakes == '是'">
                <div class="cont-item">
                    <label class="w110">代发人数</label>
                    <span>{{params.undertakes_num}}</span>
                </div>
                <div class="cont-item">
                    <label class="w110">人均代发金额</label>
                    <span class="red">{{params.undertakes_money}}</span>
                </div>
                <div class="cont-item" style="border-bottom: none;">
                    <div class="flex">
                        <label class="w110">代发账户</label>
                        <div class="cont-btn">
                            <a href="javascript:;" @click="tapPreview(params.undertakes_account, '代发账户')">预览</a>
                        </div>
                    </div>
                </div>
            </template>
        ...
        <div class="content">
            <div class="cont-item">
                <label class="w110">获客途径</label>
                <span>{{params.guest_way}}</span>
            </div>
            <div class="cont-item" style="border-bottom: none;">
                <label class="w110">所获账户</label>
                <div>
        ...
        <van-dialog v-model="excel.show" :title="excel.title" :showCancelButton="false" :showConfirmButton="true" width='380px'>
...
export default {
    ...
    methods: {
        ...
        //预览
        tapPreview(url, title) {
            this.excel.show = true;
            this.excel.title = title;
            this.excel.SheetActiveTable = '';
...
.deposit{
    ...
    box-shadow: 0px 0px 3px 0px rgba(78, 78, 78, 0.1);
    border-radius: 6px;
    margin: 12px 19px;
    padding: 6px 0;
    display: flex;
