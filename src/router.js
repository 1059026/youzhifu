    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'project-list',
          component: () => import('./views/wisdom/project-list')
        },
        {
      ...
      children: [
        {
          ...
          name: 'toAnalyzerList',
          component: () => import('./views/analyzer/scene-analyzer-list')
        },
        {
          path: 'analyzerDetail',
          meta: {
          ...
          name: 'analyzerDetail',
          component: () => import('./views/analyzer/analyzer-detail')
        },
      ]
    },
    {
      ...
      children: [
        {
          ...
          name: 'list',
          component: () => import('./views/businessAnalysis/business-list')
        },
      ]
    }
  ]
